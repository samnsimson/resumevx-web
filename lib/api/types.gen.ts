...
export type ClientOptions = {
    baseUrl: 'https://api.frezume.com' | (string & {});
};
...
export type SendVerificationOtpResponses = {
    /**
     * Successful Response
     */
    200: VerifyEmailResponse;
...
export type SendVerificationOtpResponse = SendVerificationOtpResponses[keyof SendVerificationOtpResponses];
