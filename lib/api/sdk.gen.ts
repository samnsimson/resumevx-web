...
export class DocumentApi {
     ...
     * Generate Document
     */
    public static generateDocument<ThrowOnError extends boolean = false>(options?: Options<GenerateDocumentData, ThrowOnError>) {
        return (options?.client ?? client).get<GenerateDocumentResponses, unknown, ThrowOnError>({ url: '/document/generate', ...options });
    }
}
...
export class SessionStateApi {
     ...
     * Clear Session State
     */
    public static clearSessionState<ThrowOnError extends boolean = false>(options?: Options<ClearSessionStateData, ThrowOnError>) {
        return (options?.client ?? client).delete<ClearSessionStateResponses, unknown, ThrowOnError>({ url: '/session-state', ...options });
    }
