 ...
 * Generate Document
 */
export const generateDocumentMutation = (options?: Partial<Options<GenerateDocumentData>>): UseMutationOptions<unknown, GenerateDocumentError, Options<GenerateDocumentData>> => {
